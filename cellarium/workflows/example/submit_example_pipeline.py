...
def submit_example(project_id: str = "dsp-cell-annotation-service", location: str = "us-central1", display_name: str = "model_variation_5_no_normalization_hop_score_calculation", component_1_config: str = "gs://cellarium-file-system/ml-configs/lrexp_human_validation/Model_5_alpha_half_no_normalization/model_5_alpha_half_no_normalization_prediction_config.yaml"):
    kfp_helpers.submit_pipeline(
        pipeline_func=pipelines.Model_variation_5_no_normalization_hop_score_calculation,
