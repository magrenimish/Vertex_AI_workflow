...
def model_variation_3_hop_score_calculation(config: str = "gs://cellarium-file-system/ml-configs/lrexp_human_validation/Model_variation_3/model_3_prediction_config.yaml",
                ):
    """
