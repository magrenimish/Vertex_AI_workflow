...
@dsl.component(base_image="us-central1-docker.pkg.dev/dsp-cell-annotation-service/cas-services-cicd/cas-pytorch-cuda-pipeline-dev:1.4.5-alpha.1", 
               packages_to_install=[
                   "anndata==0.10.9",
                   "git+https://github.com/cellarium-ai/cellarium-ml.git@logistic_regression_variations",
                   "gcsfs",
                   ])
def model_3(config: str = "gs://cellarium-file-system/ml-configs/Supervised_cell_classification/Model_3_lr_NT_Log1p_DBS/Model_3_config.yaml",
                ):
    """
